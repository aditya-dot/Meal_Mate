...
urlpatterns = [
    ...
    path('open_update_restaurant/<int:r_id>', views.open_update_restaurant, name = 'open_update_restaurant'),
    path('update_restaurant/<int:r_id>', views.update_restaurant, name = 'update_restaurant'),
    path('delete_restaurant/<int:r_id>', views.delete_restaurant, name = 'delete_restaurant'),
    path('open_update_menu/<int:r_id>', views.open_update_menu, name = 'open_update_menu'),
    path('update_menu/<int:r_id>', views.update_menu, name='update_menu'),
    path('view_menu/<int:r_id>/<str:username>', views.view_menu, name='view_menu'),
